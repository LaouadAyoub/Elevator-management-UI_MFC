...
// appli_ascenseur.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CappliascenseurApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construction de CappliascenseurApp

CappliascenseurApp::CappliascenseurApp()
{
...
// Le seul et unique objet CappliascenseurApp

CappliascenseurApp theApp;


// Initialisation de CappliascenseurApp

BOOL CappliascenseurApp::InitInstance()
{
